...
},{"./load":3,"audio-context":4}],3:[function(require,module,exports){
(function (Buffer){
'use strict'

var base64 = require('./base64')

var isAudioBuffer = function () { return false } // require('is-audio-buffer')
...
function load (source, options, defVal) {
  var loader =
    // Basic audio loading
      isBuffer(source) ? decodeBuffer
    : isAudioFileName(source) ? loadAudioFile
    : isPromise(source) ? loadPromise
    : isAudioBuffer(source) ? returnData
    // Compound objects
...
function isBuffer (o) {
  return o instanceof ArrayBuffer || o instanceof Buffer
}
...
},{"./base64":1,"buffer":6}],4:[function(require,module,exports){
