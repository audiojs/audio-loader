...
describe('audio-loader', function () {
  ...
  describe('Buffers', function () {
    it('loads ArrayBuffer', function () {
      ...
      return load(buffer, { options: utils.decode }).then(function (data) {
  ...
  describe('Load audio file names', function () {
    it('mp3', function () {
      ...
      return load('audio.mp3').then(function (data) {
        assert.equal(data, 'mp3 data')
      })
    })
    it('ogg', function () {
      load.fetch = fetcher({ 'audio.ogg': 'ogg data' })
      return load('audio.ogg').then(function (data) {
    ...
    it('options.from', function () {
      ...
      return load('audio.mp3', {from: 'server.com/'}).then(function (data) {
        assert.equal(data, 'mp3 data')
      })
    })
  })
