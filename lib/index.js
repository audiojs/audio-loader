 ...
 *
 * The accepted options values are (all optional):
 *
 * - {Function|String} __from__: a function or string to convert from file names to urls.
 * If is a string it will be prefixed to the name:
 * `load(ac, 'snare.mp3', { from: 'http://audio.net/samples/' })`
 * If it's a function it receives the file name and should return the url as string.
 * - {Array} only - when loading objects, only the given keys will be included
 * in the decoded object: `load(ac, 'piano.json', { only: ['C2', 'D2'] })`
 */
